...
const WORD_LIST = ["MOHAN", "NANDU", "VARUN", "RAHUL", "PAWAN"];
  ...
  render() {
    ...
    return (
      <div className={`game-container ${darkMode ? "dark" : ""}`}>
        ...
        <h1 className="main-heading color">Wordle Clone</h1>

        <div className="game-rules ">
          <h2 className="side-heading color">Game Rules</h2>
          <ul className="game-rules-list">
            <li className="rules-list color">Guess a 5-letter word.</li>
            <li className="rules-list color">
            ...
            <li className="rules-list color">Gray - Letter is not in the word.</li>
          </ul>
        </div>
